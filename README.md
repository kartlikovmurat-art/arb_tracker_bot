...
| `/trades_edit 42 k=v`            | Частичное редактирование сделки                |
| `/trades_delete 42`              | Удалить сделку                                 |
| `/confirm 42`                    | PENDING → COMPLETED (пересчёт P/L)             |
| `/search BTC`                    | Полнотекстовый поиск                           |
| `/last`                          | Последняя сделка                               |
| `/today`                         | Сделки за сегодня                              |
| `/week`                          | Сделки за неделю                               |
| `/calc`                          | Калькулятор арбитража (10 шагов, не сохраняет) |
| `/goal 1000`                     | Поставить цель по прибыли                      |
| `/goal`                          | Прогресс к цели с прогресс-баром               |
...
| `/equity`                        | Кривая доходности (текст)                     |
| `/equity_chart`                  | Кривая доходности (PNG)                        |
| `/export`                        | Выгрузить все сделки в Excel                   |
| `/backup`                        | Скачать JSON-бэкап всей базы                   |
| `/import`                        | Импортировать сделки из JSON-файла             |
